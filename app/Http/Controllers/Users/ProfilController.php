...
class ProfilController extends Controller
{
    ...
    public function form_wizard_profil_pertama(Request $request)
    {
        ...
        return Inertia::render('Profil/UMKM/profil/form_wizard_profil_pertama');
    }

    public function form_wizard_profil_kedua(Request $request){
        return Inertia::render('Profil/UMKM/profil/form_wizard_profil_kedua');
    }
    public function form_wizard_profil_ketiga(Request $request){
        return Inertia::render('Profil/UMKM/profil/form_wizard_profil_ketiga');
    }
