...
class ProfilPerusahaan extends Model
{
   ...
   public function profilPerusahaanList(){
      ...
      $data['kategori_perusahaan'] =$this->kategori_perusahaan;
      $data['deskripsi_perusahaan'] =$this->deskripsi_perusahaan;
      return $data;
    }

   public function isProfilPerusahaanComplete(){
      if ($this->nama_perusahaan && $this->alamat_perusahaan && $this->nama_pic && $this->tanggal_berdiri && $this->nomor_telepon && $this->nomor_telepon && $this->email_pic && $this->kategori_perusahaan && $this->deskripsi_perusahaan){
         return true;
      }
      return false;
    }
