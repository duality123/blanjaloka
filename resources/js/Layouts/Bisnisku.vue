              ...
              <div class="card-body">
                <h1>{{ title }}</h1>
                 ...
                 <ul class="mt-4">
                    ...
                    <Link :class="[state=='deskripsi'?'active':'']" :href="`/investor/dashboard/bisnisku/${link}`">Deskripsi</Link>                 
                  </li>
                    <li :class="[state=='daftar_umkm'?'active':'']">
                    <Link :class="[state=='daftar_umkm'?'active':'']" :href="`/investor/dashboard/bisnisku/daftar_umkm/${link}`">UMKM</Link>                 
                  </li>
                  <li :class="[state=='daftar_investor'?'active':'']">
                    <Link :class="[state=='daftar_investor'?'active':'']" :href="`/investor/dashboard/bisnisku/daftar_investor/${link}`">Investor</Link>                 
                  </li>

                  <li :class="[state=='record_investasi'?'active':'']">
                    <Link :class="[state=='record_investasi'?'active':'']" :href="`/investor/dashboard/bisnisku/investasi/${link}`">Investasi Saya</Link>                 
                  </li>
