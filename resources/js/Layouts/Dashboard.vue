        ...
        <div class="section_one mt-4">
          ...
          <ul class="mt-4">
            ...
            <li class="rounded p-4" :class="{'bg-primary-blue-2': state === 'funding'}">
              <Link href="/admin/dashboard/investasi?page=1" class="d-flex align-items-center gap-2 text-decoration-none text-neutral-black">
                <img src="../assets/icons/icon_funding_dashboard.png" alt="icon funding" class="img-fluid">Investasi
              </Link>
            </li>
            <li>
            ...
            <li class="rounded py-3 px-4" :class="{'bg-primary-blue-2': $page.url === '/pesan'}">
             ...
             <li class="rounded py-3 px-4"  :class="{ 'active': $page.url == '/admin/dashboard/janjitemu?page=1' }">
          <Link href="/admin/dashboard/janjitemu?page=1" class="d-flex align-items-center gap-2 text-decoration-none text-neutral-black">
