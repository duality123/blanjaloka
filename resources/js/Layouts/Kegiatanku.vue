              ...
              <div class="card-body">
                <h1>{{ title }}</h1>
                 ...
                 <ul class="mt-4">
                    ...
                    <Link :class="[state=='deskripsi'?'active':'']" :href="`/umkm/dashboard/kegiatanku/${link}`">Deskripsi</Link>                 </li>
                    ...
                    <li :class="[state=='eventual'?'active':'']"  >
                        <Link :class="[state=='eventual'?'active':'']" :href="`/umkm/dashboard/kegiatanku/eventual/${link}/?page=1`">Eventual</Link>
                    </li>
                    <li :class="[state=='logbook'?'active':'']" >
                         <Link :class="[state=='logbook'?'active':'']" :href="`/umkm/dashboard/kegiatanku/logbook/${link}/?page=1`">Logbook</Link>
                    </li> 
                      <li :class="[state=='tugas_akhir'?'active':'']" >
                         <Link :class="[state=='tugas_akhir'?'active':'']" :href="`/umkm/dashboard/kegiatanku/tugas_akhir/${link}/?page=1`">Tugas Akhir</Link>
                    </li>
