...
<template>
      ...
      <ul class="mt-4">
                    <li :class="[section=='logbook'?'active':'']">
                      <Link :href="`/investor/dashboard/kegiatan/${link}/logbook/${link2}`" :class="[section=='logbook'?'active':'']" >Logbook</Link>
                    </li>
                   <li :class="[section=='jawaban'?'active':'']">
                      <Link :class="[section=='jawaban'?'active':'']" :href="`/investor/dashboard/kegiatan/${link}/laporan/${link2}`">Laporan Akhir  UMKM</Link>
                    </li>
