  ...
  <DashboardLayout title="Tambah Janji Temu" state="janjitemu">
    ...
    <ul class="tabs mt-2">
      <li class="active" >
        ...
        <MultiSearchInvestor url="/admin/tambah_janji_temu_view" />
      ...
      <li class="active" >
        ...
        <MultiSearchUMKM  url="/admin/tambah_janji_temu_view"   />
...
onMounted(()=>{
  ...
  const tambahJanjiTemu=()=>{
        form.post('/admin/tambah_janji_temu',{onSuccess: () => form.reset()},{preserveState:false});
}
