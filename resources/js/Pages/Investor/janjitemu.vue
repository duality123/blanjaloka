              ...
              <div class="card-body">
                ...
                <div class="d-flex flex-column flex-lg-row gap-2 bg-primary-blue-1 rounded px-3 py-2 mt-4">
                  ...
                  <p class="fw-semibold text-primary-blue-6 mb-0">
                    Jangan lupakan agenda bertemu! Janji temu merupakan fitur penting agar Anda dapat bertemu dan diskusi bersama UMKM.
                  </p>
                </div>
                                    <h2 class="text-neutral-gray-5 mt-5 mb-3">Riwayat Janji Temu</h2>
                 <div class="col-xl-14 d-flex justify-content-start mb-2">
        <MultiSearchJanjiTemu :url="`/investor/dashboard/janjitemu?page=1`" judul="Cari Jadwal janji temu" />
                  ...
                  <table class="table">
                    ...
                    <tbody>
                       <tr v-for="(index,no) in items.data">
                        ...
                        <td>
                        <button @click="togglePopup(index.umkm.profil.user_id)" class="btn btn-primary-blue-6 me-2 px-3 text-neutral-white cursor-pointer">{{index.umkm.profil.nama_lengkap}}</button></td>
                         <td><img class="imgtd" :src="`${$page.props.asset_url}/${index.umkm.profil.foto_profil}`"></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
...
export default{
  ...
  methods:{
    ...
    Inertia.get('/investor/dashboard/janjitemu/',{id:umkm_id},{ only: ['umkm'],preserveState:true})
  },
