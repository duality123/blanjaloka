              ...
              <div class="card-body">
                <h1>{{kegiatan.tema}}</h1>
                 ...
                 <ul class="mt-4">
                    ...
                    <li :href="`/umkm/dashboard/kegiatanku/logbook/${kegiatan.id}`">
                ...
                <div class="d-flex flex-column flex-lg-row gap-2 bg-primary-blue-1 rounded px-3 py-2 mt-4">
                  ...
                  <p class="fw-semibold text-primary-blue-6 mb-0">
                    Eventual merupakan layanan konsultasi antara pelaku UMKM dan mentor setiap minggunya.
                  </p>
                </div>
...
export default{
  ...
  mounted(){
    if (this.form.errors.perihal ||  this.form.errors.kontak 

     this.form.erros.mentor) {
      this.popup =true
    }
  },
  methods:{
