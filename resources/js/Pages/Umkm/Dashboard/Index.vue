<template>
  ...
  <BaseLayout title="UMKM Dashboard">
    <section class="mt-4">
      <div class="container">
        <div class="row gap-4">
          <UmkmDashboardSidebar  section='dashboard' />
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                <h1>Dashboard</h1>
                ...
                <div v-if="!$page.props.auth.usahaComplete || !$page.props.auth.produkComplete || !$page.props.auth.finansialComplete || !$page.props.auth.profileComplete" class="d-flex flex-column flex-lg-row gap-2 bg-primary-blue-1 rounded px-3 py-2 mt-4">
                  ...
                  <p  class="fw-semibold text-primary-blue-6 mb-0">
                   Selamat!, anda sudah mendapat pendanaan dari sebuah bisnis!
                  </p>
                </div>
...
methods:{
  togglePopup(investor_id){
    ...
    Inertia.get('/umkm/dashboard',{id:investor_id},{ only: ['investor'],preserveState:true})
  },
   formToggle(){
