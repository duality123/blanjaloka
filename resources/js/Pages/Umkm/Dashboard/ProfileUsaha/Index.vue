            ...
            <div class="card">
              <div class="card-body">
                ...
                <form class="mt-4">
                  ...
                  <div class="mb-4">
                    <label for="status_perusahaan" class="form-label text-neutral-gray-5">Status Perusahaan</label>
                    <select class="form-select" id="status_perusahaan">
                      <option selected disabled>Pilih status perusahaan Anda</option>
                      <option>Start Up</option>
                      <option>Enterprice</option>
                    </select>
                  </div>
                  <div class="mb-4">
                    <label for="dokumen_legalitas" class="form-label text-neutral-gray-5 mb-2">Dokumen Legalitas</label>
                    <div class="d-flex align-items-center px-4 py-2 bg-primary-blue-1 gap-2 input_upload_custom">
                      ...
                      <div class="position-relative">
                        ...
                        <input type="file" id="dokumen_legalitas">
                      </div>
                    </div>
                  </div>
                  <div class="mb-4">
                    ...
                    <div class="d-flex align-items-center px-4 py-2 bg-primary-blue-1 gap-2 input_upload_custom">
                      ...
                      <div class="position-relative">
                        <h2 class="text-primary-blue-6">Pilih</h2>
                        <input type="file" id="dokumen_amdal">
                      </div>
                    </div>
                  </div>
                  <div class="mb-4">
                    <label for="informasi_pajak" class="form-label text-neutral-gray-5 mb-2">Informasi Pajak</label>
                    <div class="d-flex align-items-center px-4 py-2 bg-primary-blue-1 gap-2 input_upload_custom">
                      <div>
                        <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                      ...
                      <div class="position-relative">
                        <h2 class="text-primary-blue-6">Pilih</h2>
                        <input type="file" id="informasi_pajak">
                      </div>
                    </div>
                  </div>
                  <div class="mb-4">
                    <label for="npwp" class="form-label text-neutral-gray-5">NPWP</label>
                    <input type="text" class="form-control" id="npwp" placeholder="Masukkan NPWP Anda">
                  </div>
                  <div class="mb-4">
                    <label for="deskripsi_usaha" class="form-label text-neutral-gray-5">Deskripsi Usaha</label>
                    <textarea class="form-control" id="deskripsi_usaha" rows="1"
                      placeholder="Tuliskan deskripsi usaha Anda" maxlength="512" ref="refDeskripsiUsaha"
                      @input="handleResizeDeskripsiUsaha"></textarea>
                  </div>
                  <div class="mb-4">
                    <label for="email_perusahaan" class="form-label text-neutral-gray-5">Email Perusahaan</label>
                    <input type="email" class="form-control" id="email_perusahaan"
                      placeholder="Masukkan email perusahaan Anda">
                  </div>
                  <div class="mb-4">
                    <label for="alamat_perusahaan" class="form-label text-neutral-gray-5">Alamat Perusahaan</label>
                  ...
                  <div class="mb-4">
                    ...
                    <select class="form-select" id="kelurahan">
                      <option selected disabled>Pilih kelurahan perusahaan Anda</option>
                      <option>Start Up</option>
                      <option>Enterprice</option>
                    </select>
                  </div>
                  <div class="mb-4">
                    ...
                    <select class="form-select" id="kecamatan">
                      <option selected disabled>Pilih kecamatan perusahaan Anda</option>
                      <option>Start Up</option>
                      <option>Enterprice</option>
                    </select>
                  </div>
                  <div class="mb-4">
                    ...
                    <select class="form-select" id="kabupaten">
                      <option selected disabled>Pilih kabupaten perusahaan Anda</option>
                      <option>Start Up</option>
                      <option>Enterprice</option>
                    </select>
                  </div>
                  <div class="mb-4">
                    ...
                    <select class="form-select" id="provinsi">
                      <option selected disabled>Pilih provinsi perusahaan Anda</option>
                      <option>Start Up</option>
                      <option>Enterprice</option>
                    </select>
                  </div>
                  <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary-blue-3 text-neutral-white">Kirim</button>
                  </div>
                </form>
              </div>
            </div>
...
const refDeskripsiUsaha = ref(null);

const handleResizeDeskripsiUsaha = () => {
  refDeskripsiUsaha.value.style.height = `${refDeskripsiUsaha.value.scrollHeight}px`;
}
</script>
