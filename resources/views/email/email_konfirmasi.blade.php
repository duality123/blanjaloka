...
<div class="card bg-primary-blue-1" style="width: 25rem;">
              <div class="card-body">
                    ...
                    <h1 class="text-neutral-gray-5">
                      Konfirmasi email Blanjaloka anda !
                    </h1>
                    <p>Klik tombol berikut untuk verifikasi</p> 
                    <a class="btn btn-primary-blue-7 text-neutral-white py-2" href="{{$token}}">Klik disini !</a>
                  </div>
                </div>
            </div>
          </div>
